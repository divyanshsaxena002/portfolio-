...
$(document).ready(function() {
  ...
  $(function() {
    typed.typed({
      strings: ["Divyansh Saxena.", "Designer.", "Developer.", "Freelancer.", "Photographer"],
      typeSpeed: 100,
      loop: true,
    });
  });
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const projects = document.querySelectorAll(".portfolio-thumbnail");
    ...
    filters.forEach(filter => {
        filter.addEventListener("click", function () {
            ...
            projects.forEach(project => {
                if (filterValue === ".all" || project.classList.contains(filterValue.substring(1))) {
